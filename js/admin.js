...
import './admin/tabs/landing-poem.js?v=3';
...
import './admin/tabs/analytics-discovery.js?v=3';
...
import './admin/tabs/users-permissions.js?v=8';
...
window.switchTab = function (tab, keepDrawerOpen, force) {
  ...
  if (tab === 'analytics-discovery') loadDiscoveryAnalytics();
